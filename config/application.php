...
return array(
	'ServerAddress'				=> 'witcherrag.witcherworld-midgard.com',				// This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
	'BaseURI'					=> '',						// The base URI is the base web root on which your application lies.
	'InstallerPassword'			=> 'OseyfMEaGEvF5q2v',		// Installer/updater password.
	...
	'SiteTitle'					=> 'Witcher World Midgard',	// This value is only used if the theme decides to use it.
